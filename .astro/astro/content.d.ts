...
"portal/general/book-review.mdx": {
	id: "portal/general/book-review.mdx";
  slug: "portal/general/book-review";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
"portal/general/contact.mdx": {
	id: "portal/general/contact.mdx";
  slug: "portal/general/contact";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
