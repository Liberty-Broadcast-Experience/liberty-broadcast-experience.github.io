...
**Mac 2** is responsible for lyrics and clocks.

While each machine has unique responsibilities, they also serve as backups for each other.
...
2.	Have I tested playback of all videos with the Director and Broadcast A1?
    - The video should be played back in full, with no observed errors.
3.  Have I imported the lyric bundle from Mac 2?
    - Typically, this is sent after rehearsal.
4.	When is the last time I checked Dropbox? Does the content I have match what is in Dropbox?

### Mac 2
1.  Have I imported all lyrics?
2.	Have I verified that lyrics are [error free](https://google.com)?
3.  Have I sent my lyric bundle to Mac 1?
4.	Have I imported all content?
5.	When is the last time I checked Dropbox? Does the content I have match what is in Dropbox?
---
## Operation Guides
...
![Bookmarks](https://raw.githubusercontent.com/Liberty-Broadcast-Experience/img/refs/heads/main/19%20lbxtp-contentoperator-bookmarks.png)
...
3.	Download “xSpeaker Slides” folder, and all content in the root folder. Do not download LED Backgrounds.
</Steps>

![Dropbox](https://raw.githubusercontent.com/Liberty-Broadcast-Experience/img/refs/heads/main/18%20lbxtp-contentoperator-what%20to%20download.png)
...
3.	Download the most current version of NALU
</Steps>
...
<Aside type="note" title="Note">
  Ensure that you are not putting folders into Smart Playlists. For example, do not drag the "xSpeaker Slides" folder into the Convo L3 folder. Instead, drag the slides from the "xSpeaker Slides" folder in.
</Aside>
...
![Media Bin](https://raw.githubusercontent.com/Liberty-Broadcast-Experience/img/refs/heads/main/6%20lbxtp-contentoperator-media%20bin%20how.png)
...
![Media Playback Behavior](https://raw.githubusercontent.com/Liberty-Broadcast-Experience/img/refs/heads/main/20%20lbxtp-contentoperator-loop.png)
...
When verifying playback of NALU, skip ahead to a part of the video where the hosts are speaking on camera. This saves us time.
...
![Lowering Video Volume](https://raw.githubusercontent.com/Liberty-Broadcast-Experience/img/refs/heads/main/1%20lbxtp-contentoperator-audio%20levels.png)
...
2.	Once songs are identified, you’ll need to import them into the playlist for the current event.
    - Most songs are in our Campus Production song library, but occasionally we will play a new song. Refer to [Importing a new song](http://liberty-broadcast-experience.github.io/portal/video/control-room/content-operator/#importing-a-new-song) to manually import a song.
3.	Once all songs are imported, perform the following checks for all songs
    - Ensure lyric theme is 2025 PRIMARY - SUPPLY
    - Ensure all lyrics have proper spelling and grammar
    - Ensure arrangement of lyrics is correct (Planning Center may have this)
</Steps>

![Correct Lyric Theme](https://raw.githubusercontent.com/Liberty-Broadcast-Experience/img/refs/heads/main/lbxtp-contentoperator-correcttheme-2025.png)

#### Common spelling and grammar mistakes
##### Spelling
- **UK English vs US English.** Saviour > Savior
##### Grammar
- **Remove all of the following:**
  - Question marks (ex: Do you feel the world is broken?)
  - Commas (ex: Holy, holy, holy, Lord God Almighty)
  - Periods (ex: Early in the morning our song shall rise to thee.)
  - Quotations (ex: You say "I am loved")
  - Exclamation points (ex: Praise!)
- Apostrophes are ok to keep in. (for example: *He won't fail*)
...
Remember that you're not *following* the vocalists, you're *leading* them. Practically, this means advancing to the next lyric slide before the lead vocalist hits the last word of the current slide.
...
1.	First, locate lyrics to the song.
    - Planning Center is a good first place to look. You can also try [MultiTracks](https://multitracks.com) or Google.
...
7.  Group the slides accordingly (Verse, Chorus, etc...)
8.	When complete, hit import button
</Steps>
---

### Backups
Both Mac 1 and Mac 2 should have **all** content required for show, exactly mirroring each other. This is done so that in the event of a machine failure, we can failover seamlessly without affecting the event.

#### Mac 1 Procedure
<Steps>
1.	After rehearsal ends, the Mac 2 operator will export a bundle.
2.  You will find the exported bundle in the 1_ProPres Bundles folder. `(/Volumes/NL-CP-Fall2025/7_File Transfers/1_ProPres Bundles)`
3.  Double-click the bundle, and it will import in ProPresenter.
</Steps>

#### Mac 2 Procedure
<Steps>
1.  Select all songs that will be used for show.
2.  Right-click, and select "Export as Bundle"
3.  Set the file name to "YYYYMMDD_Event_Machine". (ex: 20250905_Convo_Mac2)
4.  Set the save destination to the 1_ProPres Bundles folder `(/Volumes/NL-CP-Fall2025/7_File Transfers/1_ProPres Bundles)`
5.  Notify the Mac 1 operator that your bundle has been exported.
</Steps>
...
3.	Hit Enter
4.	**Reset timer to lock in changes.** This often gets missed.
5.	Start timer
</Steps>
...
![Monitor Wall Showing Tally](https://raw.githubusercontent.com/Liberty-Broadcast-Experience/img/refs/heads/main/21%20lbxtp-contentoperator-tally.png)

If you’re live, the text will be red. If the text isn’t red, you’re clear! When in doubt, ask the director if you’re clear!

### Comms
[Click here](http://liberty-broadcast-experience.github.io/portal/general/intercom-etiquette/) to read our guide to intercom.
...
![Stage Display](https://raw.githubusercontent.com/Liberty-Broadcast-Experience/img/refs/heads/main/14%20lbxtp-contentoperator-stage%20display.png)
...
<Aside type="note" title="Note">
  If a video has timecode attached, **do not** cue the video. It will trigger the video on the LED wall. Instead, just hot-click the video.
</Aside>

If you're unsure if a video you're playing has timecode, ask the director.
...
3.	Set to auto advance every 8 seconds
</Steps>

![Preroll](https://raw.githubusercontent.com/Liberty-Broadcast-Experience/img/refs/heads/main/5%20lbxtp-contentoperator-loop.png)
